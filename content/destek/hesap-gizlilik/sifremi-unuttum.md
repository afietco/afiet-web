...
description: "Şifre sıfırlama bağlantısını isteme adımları, e-posta gelmediğinde yapılacaklar ve Apple ile giriş yaptıysan şifre belirleme."
updated: 2026-07-31
order: 1
...
Birkaç dakika bekle, sonra sırayla şunlara bak:
...
Sıfırlama bağlantıları kısa ömürlüdür ve bir kez kullanılır. Süresi dolmuş ya da daha önce kullanılmış bir bağlantıya dokunduğunda bunu söyleyen bir sayfa açılır. Giriş ekranından yeni bir bağlantı isteyebilirsin.

## Apple ile giriş yaptıysan

Apple ile hesap açtıysan bir şifren olmayabilir; giriş için şifreye ihtiyacın da yoktur, "Apple ile devam et" yeterlidir.

İstersen bir şifre de belirleyebilirsin:

```yol
Menü > Hesap ayarlarım > Şifre
```

Satırda "şifre belirle" yazıyorsa henüz şifren yok demektir.

## Hiçbiri işe yaramadıysa

[destek@afiet.co](mailto:destek@afiet.co) adresine yaz. Hesabını açarken kullandığın e-postadan yazarsan işi hızlandırırsın.
