---
slug: why-restrictive-diets-backfire
...
Weight regain after structured programmes is common and well documented. A systematic review summarised by the [UK's National Institute for Health and Care Research](https://evidence.nihr.ac.uk/alert/weight-regain-does-not-eliminate-the-long-term-benefits-of-weight-management-programmes/) found that people who lost more weight with support also "regained the lost weight more quickly", putting on "an extra 0.32kg per year more, than people who lost less weight without support".
...
The same reasoning applies to calories. The number is not evil, it is just a poor daily language: it says nothing about whether the day had vegetables in it, and it demands attention forever. Our [body mass index calculator](/en/tools/bmi-calculator) will show you where you stand today, in judgment-free range language, and it will not hand you an ideal weight either.
...
**Use proportions instead of numbers.** Half the plate vegetables, a quarter grains, a quarter protein. The NHS is explicit that you do not need to hit that balance at every meal, only "over a day or even a week". Read the longer version in [what is a balanced plate](/en/blog/what-is-a-balanced-plate).

**Measure with your hand.** A palm, a fist, a cupped hand, a thumb. No weighing, nothing to log, and the measure scales to your body. Full guide in [hand portion sizes](/en/blog/hand-portion-sizes-without-a-scale).
...
The whole approach is set out in [how to eat healthy without counting calories](/en/blog/how-to-eat-healthy-without-counting-calories). The app is in Turkish today and an English version is on the way; you can [get updates when it is ready](/en#updates).
