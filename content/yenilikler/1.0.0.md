...
summary: "Uygulama kendini bölüm bölüm anlatıyor, Sini ve Demi sofra takımına katıldı, lig kendini anlatmaya başladı, besin eklemek kısaldı. afiet'in mağazaya çıkan ilk sürümü."
---
...
- Uygulama artık kendini bölüm bölüm anlatıyor. İlk kaydından sonra Afi denge pusulanı gösteriyor; akşam günü kapatmayı ve suyu; ikinci afiyet gününde haftalık ritmi ("haftada beş"); aynı besini ikinci gün yazınca sık kurduğun sofrayı; beşinci gün yönünü (kilo hedefi değil); sofranda kim varsa ona göre birini çağırmayı; ilk görevin hazır olunca Görevlerim ve Ligim'i; dördüncü gün Sini ve Demi'yi. Günde en fazla bir bölüm; iki kez "şimdi değil" dersen bütün dersler susar, "Anlatmayı bırak" da bir dokunuş uzakta.
- Bugün panosu takvimle değil bölümlerle doluyor. İlk gün yalnız Beslenme kartı ve altında "Sofra kuruluyor" çubuğu var; her satır kendi bölümüyle geliyor, hiçbiri beşinci afiyet gününden (Görevlerim/Ligim yedinciden) öteye beklemiyor ve odası dolunca hemen açılıyor. Bir bölüm bitince parça sofraya konfetiyle iniyor. Görevlerim'in başındaki "Sofra kurulumu" dokuz parçayı, sıradakini ve her bölümü tekrar göstermeyi taşıyor.
- Bir bölümü beklemeden odasına gidersen bölüm seni orada karşılıyor: Menüm, Vücudum, Grubum, Yapay Zeka, Görevlerim ve Lig'in başında tek dokunuşla o satırı panoya alan kart.
- Kayıt iki kısa soruyla bitiyor: sofranda kim var (yalnız sıralamayı belirliyor, hiçbir şeyi kapatmıyor; davetle gelene sorulmuyor) ve sana seslenebilir miyim. Bildirim izni önce Afi'nin ağzından soruluyor; "şimdilik sessiz" dersen telefonun penceresi hiç açılmıyor. İzin verdiysen sıradaki bölümü akşam ya da ertesi sabah tek bir bildirimle hatırlatıyor.
- Apple ya da Google ile girişte adını bir daha sormuyoruz: verilen ilk ad hazır geliyor, akış emoji adımından başlıyor.
